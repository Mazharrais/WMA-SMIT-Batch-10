var questionsList  = [
    {
        question : "The S.I unit of Heat is...?",
        option1: "Watt",
        option2 : "Volt",
        option3 : "Joule",
        option4 : "Newton",
    ...
    {
        question : "Physics is one of the branches of...?",
    ...
    {
        question : "The branch of science which deals with the properties of matter and energy is called...?",
        option1 : "Biology",
        option2  : "Biology",
        option3 : "Physics",
        option4 : "Chemistry",
...
function loadQuestion(){
    var allQuestion = questionsList[index];
    question.innerText = allQuestion.question;
    option1.innerText = allQuestion.option1;
    option2.innerText = allQuestion.option2;
